...
public class AliasTicket {
    ...
    public String toString() {
        return "AliasTicket{" + "idTicket=" + idTicket + ", nameCustomer=" + nameCustomer + ", phoneNumber=" + phoneNumber + ", addressCus=" + addressCus + ", bookingDate=" + bookingDate + ", numberCoach=" + numberCoach + ", nameStaff=" + nameStaff + ", departureTime=" + departureTime + ", nameSeat=" + nameSeat + ", idCSCS=" + idCSCS + ", idCoachStrips=" + idCoachStrips + ", idStart=" + idStart + ", nameStartStation=" + nameStartStation + ", addressStart=" + addressStart + ", idEnd=" + idEnd + ", nameEndStation=" + nameEndStation + ", addressEnd=" + addressEnd + '}';
    }
}
